...
- Update example to fetch and display scores of package:ok_http from pub.dev.
- Migrate to Built-in Kotlin to support AGP 9.
- Resolve Gradle 9 deprecations.
