...
void main() {
  group('()', () {
    ...
    test('sets bodyBytes', () {
      ...
      expect(
        response.bodyBytes,
        equals([72, 101, 108, 108, 111, 44, 32, 119, 111, 114, 108, 100, 33]),
      );
    });
  ...
  group('.bytes()', () {
    ...
    test(
      ...
      () {
        ...
        var responseChinese = http.Response.bytes(
          chineseUtf8Bytes,
          200,
          headers: {'content-type': 'application/json'},
        );
    ...
    test(
      ...
      () {
        ...
        var responseKorean = http.Response.bytes(
          koreanUtf8Bytes,
          200,
          headers: {'content-type': 'application/json'},
        );
    ...
    test(
      'respects the inferred encoding for application/json content-type',
      () {
  ...
  group('.fromStream()', () {
    test('sets body', () async {
      ...
      var streamResponse = http.StreamedResponse(
        controller.stream,
        200,
        contentLength: 13,
      );
