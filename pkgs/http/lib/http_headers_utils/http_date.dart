...
abstract class HttpDate {
  ...
  ///
  /// For more information see [RFC-2616 section 3.1.1](http://tools.ietf.org/h
  /// tml/rfc2616#section-3.3.1"RFC-2616 section 3.1.1").
  ...
  static DateTime parseCookieDate(String date) {
    ...
    int toInt(String s) {
      var index = 0;
      for (; index < s.length && isDigit(s[index]); ) {
        index++;
      }
