...
void main() {
  ...
  test('mandatory fields are populated when an HttpClientRequestProfile is '
      'constructed', () async {
  ...
  test(
    'populating HttpClientRequestProfile.requestData.contentLength',
    () async {
  ...
  test(
    'populating HttpClientRequestProfile.requestData.followRedirects',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'populating HttpClientRequestProfile.requestData.headersListValues',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'HttpClientRequestProfile.requestData.headersListValues = null',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'populating HttpClientRequestProfile.requestData.headersCommaValues',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
      expect(requestData['headers'], isNull);
      expect(profile.requestData.headers, isNull);
  ...
  test(
    'HttpClientRequestProfile.requestData.headersCommaValues = null',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'populating HttpClientRequestProfile.requestData.maxRedirects',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'populating HttpClientRequestProfile.requestData.persistentConnection',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'HttpClientRequestProfile.requestData.persistentConnection = null',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
  ...
  test(
    'populating HttpClientRequestProfile.requestData.proxyDetails',
    () async {
      final requestData = backingMap['requestData'] as Map<String, dynamic>;
