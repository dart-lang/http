...
class CronetEngine {
  ...
  ///
  /// [quicHints] Adds a list of QUIC hints. Each hint is a tuple of (host,
  /// port, alternativePort) that indicates that the host supports QUIC. Note
  /// that [CacheMode.disk] or [CacheMode.diskNoHttp] is needed to take
  /// advantage of 0-RTT connection establishment between sessions.
