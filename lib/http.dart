...
Future<Response> head(Uri url,
    ...
    _withClient((client) =>
        client.head(url, headers: headers, followRedirects: followRedirects));
...
Future<Response> get(Uri url,
        {Map<String, String>? headers, bool followRedirects = true}) =>
    _withClient((client) =>
        client.get(url, headers: headers, followRedirects: followRedirects));
...
Future<String> read(Uri url,
        {Map<String, String>? headers, bool followRedirects = true}) =>
    _withClient((client) =>
        client.read(url, headers: headers, followRedirects: followRedirects));
